...
class Hangman():
    """ The Hangman class is a Python class that represents the game of Hangman. 
    ...
    ----------
    word_list: list 
         consists of words to be used in the game, in my template we have list of 5 fruits 
         ["apple", "Plum", "grape", "orange", "apricot"]
    num_lives: int 
        value representing the number of attempts the player has to guess the word 
    ...
    num_lives: int
        The number of lives the player has, this will be reduced for each incorrect letter
    ...
    def __init__(self, word_list, num_lives = 5):
        """   The __init__ method initializes the game of Hangman with a random word from a given word list and a
    specified number of lives.
        ...
        # list of words to ch0ose from ["apple", "plum", "grape", "orange", "apricot"]  
    ...
    def check_guess(self, player_guess):
        """
        The check_guess method checks if the player's guess is in the mystery word and updates the guessed letters
        ...
        if player_guess.lower() in self.mystery_word:
                 ...
                 for letter_index, letter in enumerate(self.mystery_word):
                     if letter == player_guess:
                         ...
                         print(self.mystery_word_guessed)
                         #shows updated mystery_word_guessed with correctly  guessed letters and blanks to guess
    ...
    def ask_for_input(self): 
        """
        The ask_for_input() method asks the player to input a single letter as a guess for a mystery word, checks if
        the input is valid, against two measures: 
...
def play_game(word_list):
     """ The `play_game` function is the logic of the Hangman game. It initializes the game by creating an instance of the `Hangman` class 
with the `word_list` and a default number of lives (5).
